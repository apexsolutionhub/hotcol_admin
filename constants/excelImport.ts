...
export const EXCEL_IMPORT_DEFINITIONS: ExcelImportDefinition[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      },
      {
        ...
        hint: EXCEL_IMPORT_DEPARTMENTS.join(" | ") + " (defaults to STORE)",
      },
    ],
    sampleRows: [
      {
  ...
  },
  {
    ...
    description:
      "Seed stock movements once matching items exist in inventory.",
    requiredModule: "Inventory",
    ...
    columns: [
      {
        ...
        required: false,
        hint: "Preferred when the item already exists in Hotcol",
      },
      {
        key: "itemName",
        label: "Item name",
        required: false,
        hint: "Used when ID is blank — must match an existing registration",
      },
      {
        key: "movementType",
        label: "Movement type",
    ...
    sampleRows: [
      ...
      },
      {
        ...
        amount: 1,
        stakeHolderOrReason: "Damaged in laundry",
        movementDate: "2026-03-06",
        requestedByDepartment: "HOUSE_KEEPING_ROOM",
      },
    ],
  },
];
